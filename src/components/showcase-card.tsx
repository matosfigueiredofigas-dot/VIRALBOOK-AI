...
import { ExternalLink, ChevronUp, Trash2, Globe, Zap } from "lucide-react";
...
export function ShowcaseCard({ project, currentUserId, onDelete, index = 0 }: ShowcaseCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-card border border-border/50 rounded-2xl overflow-hidden hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300"
    >
